...
_Note_: You may need to run `sudo su` in the terminal before launching the radio telescope orientation software.
...
# Optional default admin bootstrap (only used if no admin exists)
