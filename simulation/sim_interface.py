...
from simulation.sim_const import *
...
if libsimx is not None:
    ...
    c_SetJointPosition = None
    c_GetJointMatrix = None
    c_SetSphericalJointMatrix = None
    c_SetJointTargetVelocity = None
    c_SetJointTargetPosition = None
    c_GetJointForce = None
    c_GetJointMaxForce = None
    c_SetJointForce = None
    c_SetJointMaxForce = None
if libsimx is not None:
    ...
    c_ReadForceSensor = None
    c_BreakForceSensor = None
    c_ReadVisionSensor = None
    c_GetObjectHandle = None
    c_GetVisionSensorImage = None
    c_SetVisionSensorImage = None
    c_GetVisionSensorDepthBuffer = None
    c_GetObjectChild = None
    c_GetObjectParent = None
    c_ReadProximitySensor = None
    c_LoadModel = None
    c_LoadUI = None
    c_LoadScene = None
    c_StartSimulation = None
    c_PauseSimulation = None
    c_StopSimulation = None
    c_GetUIHandle = None
    c_GetUISlider = None
    c_SetUISlider = None
    c_GetUIEventButton = None
    c_GetUIButtonProperty = None
    c_SetUIButtonProperty = None
    c_AddStatusbarMessage = None
    c_AuxiliaryConsoleOpen = None
    c_AuxiliaryConsoleClose = None
    c_AuxiliaryConsolePrint = None
    c_AuxiliaryConsoleShow = None
    c_GetObjectOrientation = None
    c_GetObjectQuaternion = None
    c_GetObjectPosition = None
    c_SetObjectOrientation = None
    c_SetObjectQuaternion = None
    c_SetObjectPosition = None
    c_SetObjectParent = None
    c_SetUIButtonLabel = None
    c_GetLastErrors = None
    c_GetArrayParam = None
    c_SetArrayParam = None
    c_GetBoolParam = None
    c_SetBoolParam = None
    c_GetInt32Param = None
    c_SetInt32Param = None
    c_GetFloatParam = None
    c_SetFloatParam = None
    c_GetStringParam = None
    c_GetCollisionHandle = None
if libsimx is not None:
    ...
    c_GetDistanceHandle = None
    c_GetCollectionHandle = None
    c_ReadCollision = None
    c_ReadDistance = None
    c_CheckCollision = None
    c_CheckDistance = None
    c_RemoveObject = None
    c_RemoveModel = None
    c_RemoveUI = None
    c_CloseScene = None
    c_GetObjects = None
    c_DisplayDialog = None
    c_EndDialog = None
    c_GetDialogInput = None
    c_GetDialogResult = None
    c_CopyPasteObjects = None
    c_GetObjectSelection = None
    c_SetObjectSelection = None
    c_ClearFloatSignal = None
    c_ClearInt32Signal = None
    c_ClearStringSignal = None
    c_GetFloatSignal = None
    c_GetInt32Signal = None
    c_GetStringSignal = None
    c_SetFloatSignal = None
    c_SetInt32Signal = None
    c_SetStringSignal = None
    c_AppendStringSignal = None
    c_WriteStringStream = None
    c_GetObjectFloatParam = None
    c_SetObjectFloatParam = None
    c_GetObjectInt32Param = None
    c_SetObjectInt32Param = None
    c_GetModelProperty = None
    c_SetModelProperty = None
    c_Start = None
    c_Finish = None
    c_GetPingTime = None
    c_GetLastCmdTime = None
    c_SynchronousTrigger = None
    c_Synchronous = None
    c_PauseCommunication = None
    c_GetInMessageInfo = None
    c_GetOutMessageInfo = None
    c_GetConnectionId = None
    c_CreateBuffer = None
    c_ReleaseBuffer = None
    c_TransferFile = None
    c_EraseFile = None
    c_GetAndClearStringSignal = None
if libsimx is not None:
    ...
    c_ReadStringStream = None
    c_CreateDummy = None
    c_Query = None
    c_GetObjectGroupData = None
    c_GetObjectVelocity = None
    c_CallScriptFunction = None
...
def simxGetJointPosition(clientID, jointHandle, operationMode):
    ...
    '''
    if c_GetJointPosition is None:
        raise RuntimeError("CoppeliaSim remote API library is not loaded. Ensure 'remoteApi' is present next to sim.py and matches your OS/architecture, then restart the program.")
    position = ct.c_float()
